//This lambda is a simplified version of the following lambda provided by AWS
...
const logGroupName='${AWS::StackName}-elblog';  //Name of the log group goes here;
const logStreamName='ELB'; //Name of the log stream goes here;
...
exports.handler = (event, context, callback) => {
    ...
    s3.getObject(params, (err, data) => {
        if (err) {
            ...
            //manage the streams and push log events to CloudWatch Logs
